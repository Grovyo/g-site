  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to Grovyo Platforms Pvt Ltd, the
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Grovyo Platforms Pvt Ltd PLA, TFO.
          </p>
        </li>
        <li>
          <p>
      ...
      <ul>
        <li>
          <p>By email: grovyoinc@gmail.com</p>
        </li>
        <li></li>
      </ul>
    </div>
